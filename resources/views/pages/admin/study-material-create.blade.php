<x-AdminLayout>
    ...
    <div class=" dark:bg-gray-800 dark:border-gray-600">
        ...
        <div class="grid max-w-screen-xl mx-auto text-sm text-gray-500 dark:text-gray-400">
            <a class="p-4 bg-local bg-gray-500 bg-center bg-no-repeat bg-cover rounded-lg bg-blend-multiply hover:bg-blend-soft-light dark:hover:bg-blend-darken"
                ...
                <p class="max-w-xl mb-5 font-extrabold leading-tight tracking-tight text-white">Ini Halaman Create</p>
            </a>
        </div>
        <!-- Section Header End -->
        ...
        <section class="bg-white px-4 rounded-2xl shadow-xl py-8 antialiased dark:bg-gray-900 md:py-16">
            <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                <form method="POST" action="{{ url('/admin/materi/create') }}" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <textarea type="text" id="paragraph1" name="paragraph1" rows="8"
                                            ...
                                            placeholder="Sampaikan materi pembelajaran di sini..."></textarea>
                                    </div>
